...
class Response {
  ...
  Response.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <SearchedDataCourses>[];
      json['data'].forEach((v) {
        data!.add(new SearchedDataCourses.fromJson(v));
      });
    }
  }
...
class SearchedDataCourses {
  ...
  SearchedDataCourses.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
